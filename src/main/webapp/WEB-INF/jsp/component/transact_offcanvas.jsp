...
<%--        Payment Form Card --%>
        <c:import url="component/transact_forms/payment_form.jsp"/>
        <%--        Transfer Form Card--%>
        <c:import url="component/transact_forms/transfer_form.jsp"/>
        <%--        Deposit Form Card--%>
        <c:import url="component/transact_forms/deposit_form.jsp"/>
        <%--        Withdraw Form Card--%>
        <c:import url="component/transact_forms/withdraw_form.jsp"/>
    </div>
